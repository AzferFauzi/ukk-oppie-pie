...
export default function LoginPage() {
    ...
    // hook untuk navigasi/pindah halaman
    const router = useRouter();

    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault(); // mencegah reload halaman saat submit form
        setError('');
        setLoading(true); // set loading agar tombol tidak bisa diklik 2x

        try {
            // kirim data email & password ke api backend
            ...
            // cek role user, jika admin arahkan ke dashboard, jika user biasa ke home
    ...
    return (
        <>
            ...
            <div className="min-h-screen flex pt-16 md:pt-20">
                {/* Left Side - Image */}
                <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-amber-50 to-orange-50">
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
                    <div className="w-full max-w-md">
                        ...
                        <div className="bg-white">
                            ...
                            <p className="text-center text-gray-500 mb-8 text-sm">Log in to oppie pie website</p>
